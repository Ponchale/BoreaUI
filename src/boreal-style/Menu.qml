...
T.Menu
{
    ...
    background: BorealUI.RoundedRect {
    ...
    T.Overlay.modal: Rectangle  {
        color: Qt.rgba(control.BorealUI.Theme.backgroundColor.r,
                       control.BorealUI.Theme.backgroundColor.g,
                       control.BorealUI.Theme.backgroundColor.b, 0.4)
        Behavior on opacity {
            NumberAnimation {
                duration: 150
                easing.type: Easing.InOutCubic
