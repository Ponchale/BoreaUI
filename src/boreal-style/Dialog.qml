...
T.Dialog {
    ...
    padding: BorealUI.Theme.hugeRadius
    ...
    header: Item {
        id: _headerItem
        implicitHeight: _headerLabel.visible ? _headerLabel.implicitHeight + BorealUI.Units.largeSpacing : 0
    ...
    footer: DialogButtonBox {
        visible: count > 0
        padding: BorealUI.Units.largeSpacing * 2
    }
}