...
Item {
    ...
    property color hoveredColor: BorealUI.Theme.darkMode ? Qt.lighter(BorealUI.Theme.backgroundColor, 2)
                                                       : Qt.darker(BorealUI.Theme.backgroundColor, 1.1)
    property color pressedColor: BorealUI.Theme.darkMode ? Qt.lighter(BorealUI.Theme.backgroundColor, 1.5)
                                                       : Qt.darker(BorealUI.Theme.backgroundColor, 1.2)
