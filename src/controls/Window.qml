...
Window {
    ...
    property var windowRadius: compositing ? BorealUI.Theme.windowRadius : 0
    ...
    Rectangle {
        ...
        property var borderColor: compositing ? BorealUI.Theme.darkMode ? Qt.rgba(255, 255, 255, 0.3)
                                                                      : Qt.rgba(0, 0, 0, 0.2) : BorealUI.Theme.darkMode ? Qt.rgba(255, 255, 255, 0.15)
                                                                                                                      : Qt.rgba(0, 0, 0, 0.15)
        color: "transparent"
            ...
            RowLayout {
                ...
                RowLayout {
                    ...
                    RoundImageButton {
                        ...
                        source: "qrc:/borealui/kit/images/" + (BorealUI.Theme.darkMode ? "dark/" : "light/") + "minimize.svg"
                    ...
                    RoundImageButton {
                        size: _header.buttonSize
                        source: "qrc:/borealui/kit/images/" +
                            (BorealUI.Theme.darkMode ? "dark/" : "light/") +
                    ...
                    RoundImageButton {
                        size: _header.buttonSize
                        source: "qrc:/borealui/kit/images/" + (BorealUI.Theme.darkMode ? "dark/" : "light/") + "close.svg"
    ...
    function showPassiveNotification(message, timeout, actionText, callBack) {
        if (!internal.passiveNotification) {
            var component = Qt.createComponent("qrc:/borealui/kit/Toast.qml")
