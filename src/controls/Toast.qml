...
Popup {
    ...
    y: parent.height - height - BorealUI.Units.largeSpacing
    ...
    leftPadding: BorealUI.Units.smallSpacing
    rightPadding: BorealUI.Units.smallSpacing
    bottomPadding: BorealUI.Units.largeSpacing
    ...
    Component {
        ...
        Control {
            ...
            topPadding: BorealUI.Units.largeSpacing
            bottomPadding: BorealUI.Units.largeSpacing
            ...
            contentItem: RowLayout {
                ...
                Label {
                    id: label
                    Layout.maximumWidth: Math.min(control.parent.width - BorealUI.Units.largeSpacing * 4, implicitWidth)
